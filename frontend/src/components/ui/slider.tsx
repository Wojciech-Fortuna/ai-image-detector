...
const ST_TRACK = "#d8dde6"
const ST_RANGE = "#ff4b4b"
const ST_THUMB = "#ff4b4b"
  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        style={{ backgroundColor: ST_TRACK }}
      >
        <SliderPrimitive.Range
          ...
          style={{ backgroundColor: ST_RANGE }}
        />
      </SliderPrimitive.Track>
